...
def search(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            print(where)  #  either Questions or Choices
            return redirect("polls:searchresults", sstring, where)
    else:
        form = SearchForm()

    # render solo in caso la request sia GET, altrimenti viene redirectato in polls:searchresults
...
class SearchResultsList(ListView):
    ...
    def get_queryset(self):
        ...
        if "Questions" in where:
            ...
            # fetch delle domande relative alle Choice trovate, tramite pk
            for c in qc:
...
class VoteCastedDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if answer in correct.choice_text:
            ...
            ctx["message"] = "Wrong Answer! " + \
                " The right answer was " + str(correct.choice_text)
