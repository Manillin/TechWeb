...
urlpatterns = [
    ...
    path("searchresults/<str:sstring>/<str:where>/",
         SearchResultsList.as_view(), name="searchresults"),

    path("vote/<pk>/", vote, name="vote"),
    path("votecasted/<pk>/<str:answer>/",
         VoteCastedDetail.as_view(), name="votecasted"),
